...
var collegeName = students.sort(function (c1, c2) {
...
const sortName = students.sort((a,b)=> (a.name > b.name ? 1: -1));

console.log(sortName);

// var idSort =  id.sort(function (a,b) {
//     if (a.id > b.id) {
//         return 1;
//     }else{
//         return -1;
...
//sorting id using accending
var sortId = id.sort((a,b)=> a - b);
console.log(sortId);